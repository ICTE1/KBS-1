        ...
        <div class="login-box">
            ...
            <form action="register.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="confirm_password" class="form-control <?php echo (!empty($_SESSION['confirm_password_err'])) ? 'is-invalid' : ''; ?>">
                    <span class="help-block"><?php if($_SESSION['confirm_password_err']) { echo $_SESSION['confirm_password_err']; } ?></span>
                </div>
                <div class="form-group">
