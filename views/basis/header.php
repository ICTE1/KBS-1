            ...
            <li class="nav-item dropdown">
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="products.php?c=Novelty%20Items">Novelty Items</a>
                        <a href='products.php?c=Clothing'>Clothing</a>
                        <a href="products.php?c=Mugs">Mugs</a>
                        <a href="products.php?c=T-Shirts">T-Shirts</a>
                        <a href="products.php?c=Airline%20Novelties">Airline Novelties</a>
                        <a href="products.php?c=Computing%20Novelties">Computing Novelties</a>
                        <a href="products.php?c=USB%20Novelties">USB Novelties</a>
                        <a href="products.php?c=Furry%20Footwear">Furry Footwear</a>
                        <a href="products.php?c=Toys">Toys</a>
                        <a href="products.php?c=Packaging%20Materials">Packaging Materials</a>
                    </div>
                </div>
...
<!--        </form>-->
        ...
        <form class="form-inline my-2 search-area" method="GET" action='products.php' >
            <div class="input-group mb-3">
                <input class="form-control" type="text"  <?php print isset ($_GET['s'])? "value=".$_GET['s']:""; ?> name='s' placeholder="Zoeken...." aria-label="Search">

                <div class="input-group-append">
                    <button class="btn cbtn-primary" type="submit" value="">Zoeken</button>
                </div>
            </div>
        </form>
        ...
        <div class="navbar-nav" style="margin-left: auto">
            <div class="loginbutton">
                <a class="btn btn-default btn-outline-success my-2 my-sm-0" style="border-width: 3px" href="<?php if(isset($_SESSION["loggedin"])) { if($_SESSION["loggedin"]) { echo "logout.php"; } else { echo "logout.php"; } } else { echo "login.php"; }?>"><b><?php if(isset($_SESSION["loggedin"])) { if($_SESSION["loggedin"]) { echo "logout"; } else { echo "logout"; } } else { echo "login"; }?></b></a>
            </div>
